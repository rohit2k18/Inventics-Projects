<div role="tabpanel" class="tab-pane fade" id="Tab1">
            ...
            <div class="row">
              ...
              <div class="col-md-6"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{$img_url}}{{$product_images[0]->path}}" alt="" class="lazyload"></div>
            </div>
