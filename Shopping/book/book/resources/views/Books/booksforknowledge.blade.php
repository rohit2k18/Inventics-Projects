              ...
              <div class="prd-inside">
                ...
                <div class="prd-info">
                  <div class="prd-info-wrap">
                    ...
                    <h2 class="prd-title"><a href="{{route('Product')}}">The Book 21</a></h2>
                    <div class="prd-description">
                      Quisque volutpat condimentum velit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nam nec ante sed lacinia.
                    </div>
                    <div class="prd-action">
                      <form action="#">
                        <button class="btn js-prd-addtocart" data-product='{"name": "The Book 21", "path":"images/skins/books/products/product-21.png", "url":"{{route('Product')}}", "aspect_ratio":0.778}'>Add To Cart</button>
                      </form>
                    </div>
                  </div>
              ...
              <div class="prd-inside">
                ...
                <div class="prd-info">
                  <div class="prd-info-wrap">
                    ...
                    <div class="prd-rating justify-content-center"><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i></div>
                    <div class="prd-tag"><a href="#">Foxic</a></div>
                    <h2 class="prd-title"><a href="{{route('Product')}}">The Book 22</a></h2>
                    <div class="prd-description">
                      Quisque volutpat condimentum velit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nam nec ante sed lacinia.
                    </div>
                    <div class="prd-action">
                      <form action="#">
                        <button class="btn js-prd-addtocart" data-product='{"name": "The Book 22", "path":"images/skins/books/products/product-22.png", "url":"{{route('Product')}}", "aspect_ratio":0.778}'>Add To Cart</button>
                      </form>
                    </div>
                  </div>
                  <div class="prd-hovers">
              ...
              <div class="prd-inside">
                ...
                <div class="prd-info">
                  <div class="prd-info-wrap">
                    ...
                    <div class="prd-rating justify-content-center"><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i></div>
                    <div class="prd-tag"><a href="#">Foxic</a></div>
                    <h2 class="prd-title"><a href="{{route('Product')}}">The Book 23</a></h2>
                    <div class="prd-description">
                      Quisque volutpat condimentum velit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nam nec ante sed lacinia.
                    </div>
                    <div class="prd-action">
                      <form action="#">
                        <button class="btn js-prd-addtocart" data-product='{"name": "The Book 23", "path":"images/skins/books/products/product-23.png", "url":"{{route('Product')}}", "aspect_ratio":0.778}'>Add To Cart</button>
                      </form>
                    </div>
                  </div>
                  <div class="prd-hovers">
              ...
              <div class="prd-inside">
                ...
                <div class="prd-info">
                  <div class="prd-info-wrap">
                    ...
                    <div class="prd-action">
                      <form action="#">
                        <button class="btn js-prd-addtocart" data-product='{"name": "The Book 25", "path":"images/skins/books/products/product-25.png", "url":"{{route('Product')}}", "aspect_ratio":0.778}'>Add To Cart</button>
                      </form>
                    </div>
                  </div>
                  <div class="prd-hovers">
