...
<head>
  ...
  <title>Foxic HTML Template - Contact Page</title>
...
<body class="has-smround-btns has-loader-bg equal-height has-sm-container">
  ...
  <div class="page-content">
    <div class="holder mt-0 py-3 py-sm-5 py-md-10 bg-cover lazyload fade-up-fast" data-bgset="images/pages/contact-bg.jpg">
      <div class="container">
        <div class="row">
