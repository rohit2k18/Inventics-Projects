        ...
        <div class="row justify-content-center">
          <div class="col-lg-18 col-xl-12">
            <div class="faq-item-wrap">
              <div class="faq-item">
                <h3 class="faq-item-title">What is Foxshop</h3>
                <div class="faq-item-content">
                  <p>We will do everything we can to get your parcel to its destination as soon as possible. In central London, we can even arrange a same day courier.</p>
